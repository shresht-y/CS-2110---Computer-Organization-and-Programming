...
extern int _encrypt_name(uint8_t *cipherName, char *plainName, uint8_t xor_key);
extern int _decrypt_name(char *plainName, uint8_t *cipherName, int plainNameLength, uint8_t xor_key);
